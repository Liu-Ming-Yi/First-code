...
| :---: | :------ | :----: |
| [index.html](https://liu-ming-yi.github.io/First-code/First-HelloWorld/index.html)| [使用語法說明]([https://liu-ming-yi.github.io/First-code/First-HelloWorld/index.html](https://liu-ming-yi.github.io/First-code/First-HelloWorld/Introduction-to-tag-syntax.html) | [AI：Gemini]<br>[Refer：Google]<br>[Idea：Owner] |
...
| [RWD.html](https://liu-ming-yi.github.io/First-code/Basic-Exercises/RWD.html)| 中階 `HTML` 結構與 `<JavaScript>` 與 `<CSS>` 語法<br>要注意檔案的位置，避免抓不到資料 | [AI：Gemini] |

# 持續更新中~請敬請期待 (ง๑ •̀_•́)ง 接下來就是資料庫喽www
