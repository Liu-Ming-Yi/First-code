...
| [color-change.html](https://liu-ming-yi.github.io/First-code/CSS/color-change.html)| 基礎 `HTML` 結構與 `CSS` 語法 和 `color: red;` 屬性 <br> HTML 對對符號非常嚴格（例如 style="color: red;" 引號、冒號、分號）<br>請確保所有標籤都是成對的<br>使用 style 屬性設定顏色是最快的方式<br>建議改用 <style> 標籤或外部 CSS 檔案，以保持程式碼整潔。| [AI：Gemini]<br>[Refer：Google] |
